...
class ModelWorker:
    def __init__(
        ...
        self.model = YOLO("/home/lxj/project/yolo/runs/segment/train15/weights/best.pt") 
        # self.model = YOLO("/home/lxj/project/yolo/runs/segment/xiehe/weights/best.pt")
    ...
    def generate_stream_func(self, model, params, device):
        ...
        for result in results:
            ...
            if result.masks is not None:
                masks = result.masks.data.to(int).tolist()
            else:
                masks = None
        maskrls_list = []
...
async def api_generate(request: Request):
    ...
    #print("worker_generate output",output)
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--model-path", type=str, default='/home/lxj/project/huxi/runs/segment/train13/weights/last.pt'
    )
    parser.add_argument(
