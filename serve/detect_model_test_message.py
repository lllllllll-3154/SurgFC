...
def main():
    ...
    #names = res["names"]
    image_source = cv2.imread(args.image_path)
    for i in range(len(res["boxes"])):
        box = res["boxes"][i]
        cv2.rectangle(image_source,(box[0],box[1]),(box[2],box[3]),(0, 255, 0), 2)
        name = res["names"][i]
        cv2.putText(image_source, name, (box[0], box[1] - 5), cv2.FONT_HERSHEY_SIMPLEX, 2, (0, 0, 255), 2)
...
if __name__ == "__main__":
    ...
    parser.add_argument("--model-name", type=str, default='detect_model')

    # model parameters
    parser.add_argument(
        "--caption", type=str, default="Not needed ."
    )
    parser.add_argument(
        "--image_path", type=str, default="/home/lxj/dataset/coco_wales/images/val/2020-02-27_big_suprasellar_part_not_come_down2020-02-27_155440_VID002_150_180_280.png"
    )
    parser.add_argument(
