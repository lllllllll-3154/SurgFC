...
conv_vicuna_v0 = Conversation(
    system="A chat between a curious human and an artificial intelligence assistant. "
           "The assistant gives helpful, detailed, and polite answers to the human's questions. The bony structure includes Sella floor, Tuberculum sella, ICA prominence, Clival recess, Optic carotid recess, and Optic prominence.",
...
conv_llava_v0 = Conversation(
    system="A chat between a curious human and an artificial intelligence assistant called LLAVA. "
